...
{% hint style="info" %}
If the above looks unfamiliar, please [review the HTML section about the &lt;head&gt; tag](../html/html-head/) 👨‍💻
{% endhint %}
...
* Please refer to the [previous page](react-deployment-on-github-pages.md) to see how to make this map appear on the Internet:
