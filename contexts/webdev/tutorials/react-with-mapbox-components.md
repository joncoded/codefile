...
To create a component located within [the map from the previous section](react-with-mapbox.md):
...
Let's go back to `src/index.js` continuing off inside the `useEffect` from [this point](react-with-mapbox.md#initializing-the-map): 
