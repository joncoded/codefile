---
description: what do these three-digit codes mean on internet browsers?
---
...
| 503 | **Service unavailable** \(server just ain't there!\) |
| 504 | **Gateway timed out** \(server couldn't receive a response quick enough\) |
